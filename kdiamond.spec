...
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/kdiamond-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/kdiamond-25.04.2.tar.xz.sig
...
%setup -q -n kdiamond-25.04.2
cd %{_builddir}/kdiamond-25.04.2
pushd ..
cp -a kdiamond-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749519914
mkdir -p clr-build
pushd clr-build
