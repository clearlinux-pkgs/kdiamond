...
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/kdiamond-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/kdiamond-25.04.1.tar.xz.sig
...
%setup -q -n kdiamond-25.04.1
cd %{_builddir}/kdiamond-25.04.1
pushd ..
cp -a kdiamond-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747165343
mkdir -p clr-build
pushd clr-build
