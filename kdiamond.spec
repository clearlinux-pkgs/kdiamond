...
Version  : 22.12.3
Release  : 55
URL      : https://download.kde.org/stable/release-service/22.12.3/src/kdiamond-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/kdiamond-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/kdiamond-22.12.3.tar.xz.sig
...
%prep
%setup -q -n kdiamond-22.12.3
cd %{_builddir}/kdiamond-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677795461
mkdir -p clr-build
pushd clr-build
