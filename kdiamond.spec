...
Version  : 22.08.3
Release  : 50
URL      : https://download.kde.org/stable/release-service/22.08.3/src/kdiamond-22.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.3/src/kdiamond-22.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.3/src/kdiamond-22.08.3.tar.xz.sig
...
%prep
%setup -q -n kdiamond-22.08.3
cd %{_builddir}/kdiamond-22.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667884146
mkdir -p clr-build
pushd clr-build
