...
Version  : 23.04.0
Release  : 56
URL      : https://download.kde.org/stable/release-service/23.04.0/src/kdiamond-23.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.0/src/kdiamond-23.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.0/src/kdiamond-23.04.0.tar.xz.sig
...
%prep
%setup -q -n kdiamond-23.04.0
cd %{_builddir}/kdiamond-23.04.0
