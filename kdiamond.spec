...
Version  : 23.08.3
Release  : 64
URL      : https://download.kde.org/stable/release-service/23.08.3/src/kdiamond-23.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.3/src/kdiamond-23.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.3/src/kdiamond-23.08.3.tar.xz.sig
...
%prep
%setup -q -n kdiamond-23.08.3
cd %{_builddir}/kdiamond-23.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699579298
mkdir -p clr-build
pushd clr-build
